...
A função poderia ser modificada para estimar os valores inteiros para
...
cnvs_ann_genes_new \<- cnvs_ann_genes %\>% tidyr::unnest(cols =
...
Estimativa da amostra é o coeficiente de correlação. Para correlação de
